...
class TblContratoController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['TblContrato']))
		{
			$model->attributes=$_POST['TblContrato'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('TblContrato');
	...
	{
		$model=new TblContrato('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['TblContrato']))
			$model->attributes=$_GET['TblContrato'];
	...
	{
		$model=TblContrato::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tbl-contrato-form')
		{
